...
<body>
    ...
    <?php
        ...
        ?>
    <section class="conteudo_techinfo">
        <div>
            <div class="conteudo_techinfo_titulo">
                <h1>Técnico em Informática</h1>
            </div>
            <div class="conteudo_techinfo_texto">
                <p>Você busca uma oportunidade de inserção no mercado de trabalho? A área de Informática
                    fascina você? Gostaria de agregar conhecimentos fundamentais para os mais diversos segmentos
                    profissionais? Se as respostas forem sim, o curso Técnico em Informática do Senac-RS foi feito para
                    você!<br><br>
                    ...
                    preservação
                    ambiental no desempenho de sua função.<br><br>
                    ...
                    momentos
                    mediados por tecnologia**, em uma plataforma educacional própria, com conteúdos produzidos por
                    tutores
                    ...
                    Total de horas do curso: 1.200h<br><br>

                    - Momentos presenciais*: 996h<br><br>

                    - Momentos mediados por tecnologias com tutoria ativa**: 204h (no formato EAD - Educação a
                    Distância)<br><br>
                    ...
                    Gostou da ideia de ser um profissional completo da área de Informática? Venha para o curso Técnico
                    em
                    Informática e mude de vida.<br><br>
                </p>
            </div>
            <div class="conteudo_techinfo_imagem">
                <img src="../../images/tech_info.jpg" alt="Técnico em Informática" hspace="8"
                    title="Técnico em Informática" class="conteudo_techinfo_imagem_imagem">
            </div>
        </div>
    </section>
    <footer class="rodape">
