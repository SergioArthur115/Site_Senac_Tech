...
<body>
    ...
    <section class="conteudo_faleConosco">
        <div>
            ...
            <p class="texto_forms">O Senac-RS tem a maior satisfação em atendê-lo.
                Importante: preencha corretamente os campos do formulário a seguir, para que possamos lhe dar um
                retorno.</p>
            <form action="../banco/processaFaleConosco.php" method="post" class="conteudo_faleConosco_formulario">
                <table>
                    <thead>
                        <tr>
                            <td colspan="2" class="td_forms">
                                <h3 class="subtitulo_tabela">Todos os campos são obrigatórios</h3>
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td class="td_forms">
                                <h3><label>Confirme o E-mail:</label></h3>
                            </td>
                            <td>
                                <input type="email" name="email" required placeholder="nome@dominio.com">
                            </td>
                        ...
                        <tr>
                            <td class="td_forms">
                                <h3><label>Modalidade:</label></h3>
                            </td>
                            <td>
                                <select name="modalidade" required>
                                    <option selected value="">Selecione a modalidade</option>
                                    <option value="cp">Curso Presencial</option>
                                    <option value="ct">Curso Técnico EAD</option>
                        ...
                        <tr>
                            <td class="td_forms">
                                <h3><label>Assunto:</label></h3>
                            </td>
                            <td>
                                <select name="assunto" required>
                                    <option selected value="">Selecione o Assunto</option>
                                    <option value="di">Dúvidas/Informações</option>
                                    <option value="soli">Solicitações</option>
                                    <option value="elo">Elogios</option>
                                    <option value="suges">Sugestões</option>
                                    <option value="recla">Reclamações</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
